...
import { PostrgresCyberPhysicalSystemsRepository } from '@/cyber-physical-systems/repositories/postgres-cyber-physical-systems.repository';
...
@Module({
  ...
  providers: [
    CyberPhysicalSystemsService,
    {
      ...
      useClass: PostrgresCyberPhysicalSystemsRepository,
    },
  ],
